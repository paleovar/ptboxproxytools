...
```{r}
library(PTBoxProxytools) # loads PTBoxProxydata dependency
library(PTBoxProxydata) # remove for public
...
icecore_data <- load_set(mng, dataset_names = 'icecore_testset', zoo_format = 'zoo')
...
library(PaleoSpec)
PaleoSpec::LPlot(testout$d18O$raw, col="grey")
PaleoSpec::LLines(testout$d18O$logsmooth, col="darkblue")
```
